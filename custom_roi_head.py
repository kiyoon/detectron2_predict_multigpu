# The custom ROI head will return NMS kept indices as well as box outputs.
...
class StandardROIHeadsCustom(ROIHeads):
    """
    ...
    def __init__(self, cfg, input_shape):
        super(StandardROIHeadsCustom, self).__init__(cfg, input_shape)
    ...
    def forward(self, images, features, proposals, targets=None):
        ...
        if self.training:
            ...
            pred_instances, kept_indices = self._forward_box(features_list, proposals)
